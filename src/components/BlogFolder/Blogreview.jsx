      ...
      <div className="w-[200px] p-3 bg-slate-400 flex-col justify-between items-start hidden md:block ">
        <div className="self-stretch  flex-col justify-start items-start gap-2 flex">
          <div className=" justify-start items-center flex">
            <img
              src={Quote}
              alt=""
              className="w-[45.02px] h-10 relative opacity-75"
            />
            <p className=" text-white text-[15px] font-bold lg:text-[16px]">
              Wireless Earbuds
            </p>
          </div>

          <p className="self-stretch text-white text-[12.7px] ">
        ...
        <div className="self-stretch justify-center items-center gap-3 flex mt-[10px] ">
          ...
          <div className="w-full justify-start items-start block ">
            ...
            <p className=" text-white text-xs font-normal">Programmer</p>
          </div>
        </div>
      </div>
    </div>
