...
export const Newsletteremail = () => {
  return (
    <div> 
      <div className="w-[571px] h-[187px] px-14 py-8 bg-slate-400 rounded-lg flex-col items-center gap-6 flex absolute justify-center left-[100px] lg:left-[350px]">
        ...
        <div className="w-[268px] px-3 py-2 bg-white rounded justify-start items-center gap-[127px] inline-flex">
          <div >
            <input type="text" placeholder='Enter your email' className="text-right text-neutral-400 text-sm font-normal leading-tight" />
          </div>
