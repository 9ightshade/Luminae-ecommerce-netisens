  ...
  return (
    <div>
      <div
       ...
       bg-white justify-center text-black"
      >
        <div className="w-[200px] block m-auto">
          <div className="w-[200px]  justify-start gap-4 mb-[20px] py-[20px] flex fixed top-0 bg-white ">
            <img src={category} alt="" />
            <p className="font-bold text-[16px]">All Categories</p>
          </div>

          <div className='pt-[60px]'>
            <div>
              <p className="font-bold my-[10px] text-[16px]">Brand</p>
