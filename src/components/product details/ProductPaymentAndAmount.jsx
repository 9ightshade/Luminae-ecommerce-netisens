...
export const ProductPaymentAndAmount = () => {
  return (
    <div>
      <div className=" px-6 py-3 bg-gray-200 rounded flex-col justify-start items-start gap-2 inline-flex m-[20px] border-red-500">
        <p className=" text-neutral-800 text-lg font-bold">$79.98</p>
